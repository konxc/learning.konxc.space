...
export async function seedUsers(db: NeonHttpDatabase<typeof schema>) {
	...
	const users = [
		...
		// Mentors — role: 'user' (org role is set via organization_member)
		{
			id: 'mentor-001',
		...
		// Facilitators — role: 'user' (org role is set via organization_member)
		{
			id: 'facil-001',
...
export async function seedStudents(db: NeonHttpDatabase<typeof schema>) {
	...
	const students = [
		...
		{
			id: 'std-012',
			username: 'maya_rahmawati',
			fullName: 'Maya Rahmawati',
		...
		{
			id: 'std-013',
			username: 'nando_pratama',
			fullName: 'Nando Pratama',
			email: 'nando.p@gmail.com',
			phone: '081234568013',
			createdAt: new Date('2024-02-03')
		},
		{
			id: 'std-014',
			username: 'okta_firmansyah',
			fullName: 'Okta Firmansyah',
			email: 'okta.f@gmail.com',
			phone: '081234568014',
			createdAt: new Date('2024-02-04')
		},
		{
			id: 'std-015',
			username: 'putri_amalia',
		...
		{
			id: 'std-016',
			username: 'qori_hidayat',
			fullName: 'Qori Hidayat',
			email: 'qori.h@gmail.com',
			phone: '081234568016',
		...
		},
		{
			...
			username: 'ratna_sari',
			fullName: 'Ratna Sari',
			email: 'ratna.s@gmail.com',
			phone: '081234568017',
			createdAt: new Date('2024-02-07')
		},
		{
			id: 'std-018',
			username: 'surya_darmawan',
		...
		{
			id: 'std-019',
			username: 'tika_marlina',
			fullName: 'Tika Marlina',
			email: 'tika.m@gmail.com',
			phone: '081234568019',
			createdAt: new Date('2024-02-09')
		},
		{
			id: 'std-020',
			username: 'umar_basuki',
			fullName: 'Umar Basuki',
		...
		{
			id: 'std-021',
			username: 'vina_puspita',
			fullName: 'Vina Puspita',
			email: 'vina.p@gmail.com',
			phone: '081234568021',
		...
		},
		{
			id: 'std-022',
			username: 'wahyu_adi',
			fullName: 'Wahyu Adi Prakoso',
			email: 'wahyu.a@gmail.com',
			phone: '081234568022',
			createdAt: new Date('2024-03-02')
		},
		{
			id: 'std-023',
			username: 'xena_oktavia',
			fullName: 'Xena Oktavia',
			email: 'xena.o@gmail.com',
			phone: '081234568023',
			createdAt: new Date('2024-03-03')
		},
		{
			id: 'std-024',
			username: 'yoga_permadi',
			fullName: 'Yoga Permadi',
			email: 'yoga.p@gmail.com',
			phone: '081234568024',
			createdAt: new Date('2024-03-04')
		},
		{
			id: 'std-025',
			username: 'zahra_fadila',
			fullName: 'Zahra Fadila',
		...
		{
			id: 'std-027',
			username: 'bella_rahma',
			fullName: 'Bella Rahma',
		...
		{
			id: 'std-028',
			username: 'candra_gunawan',
			fullName: 'Candra Gunawan',
			email: 'candra.g@gmail.com',
			phone: '081234568028',
		...
		},
		{
			id: 'std-033',
			username: 'halimahtul',
			fullName: 'Halimahtul Zahra',
			email: 'halimahtul@gmail.com',
			phone: '081234568033',
			createdAt: new Date('2024-04-03')
		},
		{
			id: 'std-034',
			username: 'indra_permadi',
			fullName: 'Indra Permadi',
			email: 'indra.p@gmail.com',
			phone: '081234568034',
			createdAt: new Date('2024-04-04')
		},
		{
			id: 'std-035',
			username: 'jihan_azzahra',
			fullName: 'Jihan Azzahra',
			email: 'jihan.a@gmail.com',
			phone: '081234568035',
			createdAt: new Date('2024-04-05')
		},
		{
			id: 'std-036',
			username: 'kiki_amelia',
			fullName: 'Kiki Amelia',
			email: 'kiki.a@gmail.com',
			phone: '081234568036',
			createdAt: new Date('2024-04-06')
		},
		{
			id: 'std-037',
			username: 'lutfi_hamzah',
			fullName: 'Lutfi Hamzah',
		...
		{
			id: 'std-038',
			username: 'mira_ophelia',
			fullName: 'Mira Ophelia',
			email: 'mira.o@gmail.com',
			phone: '081234568038',
			createdAt: new Date('2024-04-08')
		},
		{
			id: 'std-039',
			username: 'naufal_aziz',
			fullName: 'Naufal Aziz',
			email: 'naufal.a@gmail.com',
			phone: '081234568039',
			createdAt: new Date('2024-04-09')
		},
		{
			id: 'std-040',
			username: 'olivia_sari',
		...
		{
			id: 'std-041',
			username: 'panji_wicaksono',
			fullName: 'Panji Wicaksono',
			email: 'panji.w@gmail.com',
			phone: '081234568041',
			createdAt: new Date('2024-05-01')
		},
		{
			id: 'std-042',
			username: 'qonita_zahra',
			fullName: 'Qonita Zahra',
			email: 'qonita.z@gmail.com',
			phone: '081234568042',
		...
		},
		{
			id: 'std-043',
			username: 'raka_budi',
			fullName: 'Raka Budi Santoso',
			email: 'raka.b@gmail.com',
			phone: '081234568043',
		...
		},
		{
			id: 'std-044',
			username: 'salsa_bila',
			fullName: 'Salsa Bila Ramadhani',
			email: 'salsa.b@gmail.com',
			phone: '081234568044',
		...
		},
		{
			...
			username: 'utami_dewi',
			fullName: 'Utami Dewi',
			email: 'utami.d@gmail.com',
			phone: '081234568046',
			createdAt: new Date('2024-05-06')
		},
		{
			id: 'std-047',
			username: 'vito_rahman',
			fullName: 'Vito Rahman',
			email: 'vito.r@gmail.com',
			phone: '081234568047',
		...
		},
		{
			id: 'std-048',
			username: 'winda_ayu',
			fullName: 'Winda Ayu Lestari',
			email: 'winda.a@gmail.com',
			phone: '081234568048',
			createdAt: new Date('2024-05-08')
		},
		{
			id: 'std-049',
			username: 'xaverius_dwi',
			fullName: 'Xaverius Dwi Putra',
			email: 'xaverius.d@gmail.com',
			phone: '081234568049',
			createdAt: new Date('2024-05-09')
		},
		{
			id: 'std-050',
			username: 'yusuf_maulana',
		...
		{
			id: 'std-051',
			username: 'zakiyah_nur',
			fullName: 'Zakiyah Nur Hidayah',
			email: 'zakiyah.n@gmail.com',
			phone: '081234568051',
			createdAt: new Date('2024-06-01')
		},
		{
			id: 'std-052',
			username: 'arifin_setiadi',
			fullName: 'Arifin Setiadi',
		...
		{
			id: 'std-053',
			username: 'berlian_ayu',
			fullName: 'Berlian Ayu Sasmita',
			email: 'berlian.a@gmail.com',
			phone: '081234568053',
			createdAt: new Date('2024-06-03')
		},
		{
			id: 'std-054',
			username: 'dedi_susanto',
		...
		{
			id: 'std-055',
			username: 'elfira_lestari',
			fullName: 'Elfira Lestari',
			email: 'elfira.l@gmail.com',
			phone: '081234568055',
			createdAt: new Date('2024-06-05')
		},
		{
			id: 'std-056',
			username: 'guntur_mahendra',
			fullName: 'Guntur Mahendra',
			email: 'guntur.m@gmail.com',
			phone: '081234568056',
			createdAt: new Date('2024-06-06')
		},
		{
			id: 'std-057',
			username: 'hesti_wulandari',
			fullName: 'Hesti Wulandari',
			email: 'hesti.w@gmail.com',
			phone: '081234568057',
			createdAt: new Date('2024-06-07')
		},
		{
			id: 'std-058',
			username: 'ivan_pratama',
			fullName: 'Ivan Pratama',
		...
		{
			id: 'std-059',
			username: 'julia_puspita',
			fullName: 'Julia Puspita Sari',
			email: 'julia.p@gmail.com',
			phone: '081234568059',
