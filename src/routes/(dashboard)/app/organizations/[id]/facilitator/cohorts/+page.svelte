		...
		<PageSection>
			<div class="py-16 text-center">
				...
				<p class={`${TEXT.body} ${COLOR.textMuted} mb-6`}>
					You haven't been assigned as a facilitator for any cohorts in this organization yet.
				</p>
			</div>
		</PageSection>
	{:else}
		<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
			{#each data.cohorts as cohort}
				{#if data.membership}
					<a
						href="/app/organizations/{data.membership.orgId}/facilitator/cohorts/{cohort.id}"
